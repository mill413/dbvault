<template>
  <div class="databases">
    <el-card>
      ...
      <el-table :data="databases" v-loading="loading" style="width: 100%" size="default" empty-text="No data available">
        ...
        <el-table-column label="操作" width="220" fixed="right">
          <template #default="{ row }">
            <el-button size="small" @click="testConnection(row)">Test Connection</el-button>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? 'Edit Instance' : 'Add Instance'" width="600px">
